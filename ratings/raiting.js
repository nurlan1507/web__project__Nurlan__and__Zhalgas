...
if (localStorage.getItem('result1') == null) {
    localStorage.setItem('result1', 0.0);
}
if (localStorage.getItem('result2') == null) {
    localStorage.setItem('result2', 0.0);
}
if (localStorage.getItem('result3') == null) {
    localStorage.setItem('result3', 0.0);
}
//firts meal
...
block1.append(localStorage.getItem('result1'));
btn1.addEventListener('click', function() {
    let first_arr = JSON.parse(localStorage.getItem('first_arr')) || [];
    ...
    window.localStorage.setItem('first_arr', JSON.stringify(first_arr));
});
...
block2.append(localStorage.getItem('result2'));
btn2.addEventListener('click', function() {
    let second_arr = JSON.parse(localStorage.getItem('second_arr')) || [];
    ...
    window.localStorage.setItem('second_arr', JSON.stringify(second_arr));
});
...
block3.append(localStorage.getItem('result3'));
btn3.addEventListener('click', function() {
    let third_arr = JSON.parse(localStorage.getItem('third_arr')) || [];
    ...
    window.localStorage.setItem('third_arr', JSON.stringify(third_arr));
    localStorage.setItem('result3', total3);
});
