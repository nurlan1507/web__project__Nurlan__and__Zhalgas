...
if (localStorage.getItem('result41') == null) {
    localStorage.setItem('result41', 0.0);
}
if (localStorage.getItem('result42') == null) {
    localStorage.setItem('result42', 0.0);
}
if (localStorage.getItem('result43') == null) {
    localStorage.setItem('result43', 0.0);
}
//firts meal
...
block1.append(localStorage.getItem('result41'));
btn1.addEventListener('click', function() {
    let first_arr = JSON.parse(localStorage.getItem('first_arr4')) || [];
    ...
    res = 0;
    localStorage.setItem('result41', total1);
    block1.replaceChildren(total1);
    window.localStorage.setItem('first_arr4', JSON.stringify(first_arr));
});
...
block2.append(localStorage.getItem('result42'));
btn2.addEventListener('click', function() {
    let second_arr = JSON.parse(localStorage.getItem('second_arr4')) || [];
    ...
    localStorage.setItem('result42', total2);
    res = 0;
    block2.replaceChildren(total2);
    window.localStorage.setItem('second_arr4', JSON.stringify(second_arr));
});
...
block3.append(localStorage.getItem('result43'));
btn3.addEventListener('click', function() {
    let third_arr = JSON.parse(localStorage.getItem('third_arr4')) || [];
    ...
    window.localStorage.setItem('third_arr4', JSON.stringify(third_arr));
    localStorage.setItem('result43', total3);
});
