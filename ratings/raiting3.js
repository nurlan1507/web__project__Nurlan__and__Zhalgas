...
if (localStorage.getItem('result31') == null) {
    localStorage.setItem('result31', 0.0);
}
if (localStorage.getItem('result32') == null) {
    localStorage.setItem('result32', 0.0);
}
if (localStorage.getItem('result33') == null) {
    localStorage.setItem('result33', 0.0);
}
//firts meal
...
block1.append(localStorage.getItem('result31'));
btn1.addEventListener('click', function() {
    let first_arr = JSON.parse(localStorage.getItem('first_arr3')) || [];
    ...
    res = 0;
    localStorage.setItem('result31', total1);
    block1.replaceChildren(total1);
    window.localStorage.setItem('first_arr3', JSON.stringify(first_arr));
});
...
block2.append(localStorage.getItem('result32'));
btn2.addEventListener('click', function() {
    let second_arr = JSON.parse(localStorage.getItem('second_arr3')) || [];
    ...
    localStorage.setItem('result32', total2);
    res = 0;
    block2.replaceChildren(total2);
    window.localStorage.setItem('second_arr3', JSON.stringify(second_arr));
});
...
block3.append(localStorage.getItem('result33'));
btn3.addEventListener('click', function() {
    let third_arr = JSON.parse(localStorage.getItem('third_arr3')) || [];
    ...
    window.localStorage.setItem('third_arr3', JSON.stringify(third_arr));
    localStorage.setItem('result33', total3);
});
